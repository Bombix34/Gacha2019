...
Shader "TriplanarSphere"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 triplanar1 = TriplanarSamplingSF( _Main_Texture, localPos, localNormal, 1.0, 1.0, 1.0, 0 );
